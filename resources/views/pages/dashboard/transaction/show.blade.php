<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow sm:rounded-lg mb-18">
                <div class="p-6 bg-white border-b brder-gray-200">
            ...
            <h2 class="font-semibold text-lg text-gray-800 leading-tight mb-5 mt-3">
                Transaction Item
            </h2>
